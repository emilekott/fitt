	...
	function addCoupon(&$coupon1, &$products, &$currency, $discountmode) {
		...
		switch ($discountmode) {
			case 2:
				...
				break;
			default:
				$coupon2->total->prices[0]->price_value_without_discount_with_tax = $totalnondiscount_with_tax;
				$coupon2->total->prices[0]->price_value_without_discount = $totalnondiscount;

...
<form action="index.php?option=<?php echo HIKASHOP_COMPONENT ?>&amp;ctrl=banner" method="post" name="adminForm" enctype="multipart/form-data">
	<?php 
	...
	<table class="admintable" width="100%">
		<tr>
			...
			<td>
				<?php echo JHTML::_('select.booleanlist', "data[banner][banner_published]" , '',@$this->element->banner_published); ?>
			</td>
		</tr>
	</table>				

...
<fieldset>
	<div class="toolbar" id="toolbar" style="float: right;">
		<button type="button" onclick="submitbutton('savepartner');"><img src="<?php echo HIKASHOP_IMAGES; ?>save.png"/><?php echo JText::_('OK'); ?></button>
	</div>
</fieldset>
...
<form action="<?php echo hikashop_completeLink('order',true); ?>" method="post" name="adminForm">
	<table width="100%" class="admintable">
		...
		<tr>
			...
			<td>
				<?php echo JHTML::_('select.booleanlist', "data[order][order_partner_paid]" , '',@$this->element->order_partner_paid	); ?>
			</td>
		</tr>
	</table>

...
<fieldset>
	<div class="toolbar" id="toolbar" style="float: right;">
		<button type="button" onclick="submitbutton('savechangestatus');"><img src="<?php echo HIKASHOP_IMAGES; ?>save.png"/><?php echo JText::_('OK'); ?></button>
	</div>
</fieldset>
...
<form action="<?php echo hikashop_completeLink('order',true); ?>" method="post" name="adminForm">
	...
	<input type="hidden" id="data[order][order_status]" name="data[order][order_status]" value="<?php echo @$this->element->order_status; ?>" />

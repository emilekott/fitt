...
<form action="index.php?tmpl=component&amp;option=<?php echo HIKASHOP_COMPONENT ?>" method="post" name="adminForm" >
	<fieldset>
		...
		<div class="toolbar" id="toolbar" style="float: right;">
			<button type="button" onclick="javascript:submitbutton('savelanguage'); return false;"><?php echo JText::_('HIKA_SAVE'); ?></button>
			<button type="button" onclick="javascript:submitbutton('share'); return false;"><?php echo JText::_('SHARE'); ?></button>
		</div>
	</fieldset>

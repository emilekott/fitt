...
<fieldset>
	<div class="toolbar" id="toolbar" style="float: right;">
		<button type="button" onclick="submitbutton('savemodules');"><img src="<?php echo HIKASHOP_IMAGES; ?>save.png"/><?php echo JText::_('OK'); ?></button>
	</div>
</fieldset>
			...
			?>
				<tr class="<?php echo "row$k"; ?>">
					...
					<td align="center" nowrap>
						<?php echo JHTML::_('select.booleanlist', 'data[module][used]['.$row->id.']' , '',@$row->module_used); ?>
					</td>

...
<div style="float:right">
	<button type="button" onclick="submitbutton('managevariant');">
		<img src="<?php echo HIKASHOP_IMAGES; ?>edit.png"/><?php echo JText::_('MANAGE_VARIANTS');?>
	</button>
	<a class="modal" rel="{handler: 'iframe', size: {x: 760, y: 480}}" href="<?php echo hikashop_completeLink("characteristic&task=selectcharacteristic",true ); ?>">

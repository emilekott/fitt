...
<table class="adminlist" cellpadding="1" width="100%">
	...
	<?php
		...
		<tr id="characteristic_<?php echo $row->characteristic_id.'_'.$id;?>">
			<td>
				<a class="modal" rel="{handler: 'iframe', size: {x: 760, y: 480}}" href="<?php echo hikashop_completeLink("characteristic&task=editpopup&cid=".$row->characteristic_id.'&characteristic_parent_id='.$row->characteristic_parent_id.'&id='.$id,true ); ?>" onclick="SqueezeBox.fromElement(this,{parse: 'rel'});return false;">

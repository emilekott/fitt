...
<tr>
	...
	<td>
		<?php echo JHTML::_('select.booleanlist', "data[payment][payment_params][cv2mandatory]" , '',@$this->element->payment_params->cv2mandatory	); ?>
	</td>
</tr>
<tr>
	<td class="key">
	...
	<td>
		<?php echo JHTML::_('select.booleanlist', "data[payment][payment_params][address1mandatory]" , '',@$this->element->payment_params->address1mandatory	); ?>
	</td>
</tr>
<tr>
	<td class="key">
	...
	<td>
		<?php echo JHTML::_('select.booleanlist', "data[payment][payment_params][citymandatory]" , '',@$this->element->payment_params->citymandatory	); ?>
	</td>
</tr>
<tr>
	<td class="key">
	...
	<td>
		<?php echo JHTML::_('select.booleanlist', "data[payment][payment_params][postcodemandatory]" , '',@$this->element->payment_params->postcodemandatory	); ?>
	</td>
</tr>
<tr>
	<td class="key">
	...
	<td>
		<?php echo JHTML::_('select.booleanlist', "data[payment][payment_params][statemandatory]" , '',@$this->element->payment_params->statemandatory	); ?>
	</td>
</tr>
<tr>
	<td class="key">
	...
	<td>
		<?php echo JHTML::_('select.booleanlist', "data[payment][payment_params][countrymandatory]" , '',@$this->element->payment_params->countrymandatory	); ?>
	</td>
</tr>

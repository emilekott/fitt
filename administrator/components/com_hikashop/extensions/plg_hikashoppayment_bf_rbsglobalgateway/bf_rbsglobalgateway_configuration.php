...
<tr>
	<td class="key">
		<label for="data[payment][payment_params][paymentRefField]">RBS Reference Order Field<br /><div style="font-size:70%;">(Commercial version only)</div></label>
	</td>
	<td>
...
<tr>
	<td class="key">
		<label for="data[payment][payment_params][responseRefField]">RBS Enquiry Response Field<div style="font-size:70%;">(Commercial version only)</div></label>
	</td>
	<td>
...
<tr>
	...
	<td>
		<?php echo JHTML::_('select.booleanlist', "data[payment][payment_params][show_tax_amount]" , '',@$this->element->payment_params->show_tax_amount	); ?>
	</td>
</tr>
<tr>
	<td class="key">

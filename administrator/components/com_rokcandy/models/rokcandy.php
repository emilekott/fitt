...
class RokCandyModelRokCandy extends JModel
{
	...
	function _buildContentOrderBy()
    {
		...
		$filter_order		= $app->getUserStateFromRequest( $this->option.'filter_order',		'filter_order',		'a.ordering',	'cmd' );
	...
	function _buildContentWhere()
	{
		...
		$filter_catid		= $app->getUserStateFromRequest( $this->option.'filter_catid',		'filter_catid',		0,				'int' );
		$filter_order		= $app->getUserStateFromRequest( $this->option.'filter_order',		'filter_order',		'a.ordering',	'cmd' );
		$filter_order_Dir	= $app->getUserStateFromRequest( $this->option.'filter_order_Dir',	'filter_order_Dir',	'',				'word' );
		$search				= $app->getUserStateFromRequest( $this->option.'search',			'search',			'',				'string' );

...
<tr>
	...
	<td>
		<?php echo JHTML::_('select.booleanlist', "data[payment][payment_params][enable_validation]" , '',@$this->element->payment_params->enable_validation	); ?>
	</td>
</tr>
<tr>
	<td class="key">
...
<tr>
	...
	<td>
		<?php echo JHTML::_('select.booleanlist', "data[payment][payment_params][force_instalments]" , '',@$this->element->payment_params->force_instalments	); ?>
	</td>
</tr>
<tr>
	<td class="key">
...
<tr>
	...
	<td>
		<?php echo JHTML::_('select.booleanlist', "data[payment][payment_params][notification]" , 'yes',@$this->element->payment_params->notification	); ?>
	</td>
</tr>
<tr>
	<td class="key">

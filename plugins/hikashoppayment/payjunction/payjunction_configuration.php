...
<tr>
	...
	<td>
		<?php echo JHTML::_('select.booleanlist', "data[payment][payment_params][security]" , 'onclick="payjunction_avs_radio(this);" onchange="payjunction_avs_radio(this);"',@$this->element->payment_params->security ); ?>
	</td>
</tr>
</table>
...
<tr>
	...
	<td>
		<?php echo JHTML::_('select.booleanlist', "data[payment][payment_params][security_cvv]" , '',@$this->element->payment_params->security_cvv ); ?>
	</td>
</tr>
<tr>
	<td class="key">
	...
	<td>
		<?php echo JHTML::_('select.booleanlist', "data[payment][payment_params][security_preauth]" , '',@$this->element->payment_params->security_preauth ); ?>
	</td>
</tr>
<tr>
	<td class="key">
	...
	<td>
		<?php echo JHTML::_('select.booleanlist', "data[payment][payment_params][security_avsforce]" , '',@$this->element->payment_params->security_avsforce ); ?>
	</td>
</tr>
<tr>
	<td class="key">
	...
	<td>
		<?php echo JHTML::_('select.booleanlist', "data[payment][payment_params][security_cvvforce]" , '',@$this->element->payment_params->security_cvvforce ); ?>
	</td>
</tr>
</table>

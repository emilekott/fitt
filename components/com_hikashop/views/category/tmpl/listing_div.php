...
if(!empty($this->rows)){
	...
	<form action="<?php echo hikashop_completeLink(JRequest::getWord('ctrl').'&task='.JRequest::getWord('task').'&cid='.$this->pageInfo->filter->cid.$this->menu_id);?>" method="post" name="adminForm_<?php echo $this->params->get('main_div_name').$this->category_selected;?>_top">
	...
	<form action="<?php echo hikashop_completeLink(JRequest::getWord('ctrl').'&task='.JRequest::getWord('task').'&cid='.$this->pageInfo->filter->cid.$this->menu_id);?>" method="post" name="adminForm_<?php echo $this->params->get('main_div_name').$this->category_selected;?>_bottom">
		<div class="hikashop_subcategories_pagination">
		<?php echo $this->pagination->getListFooter(); ?>
		<span class="hikashop_results_counter"><?php echo $this->pagination->getResultsCounter(); ?></span>
		</div>

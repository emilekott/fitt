<div class="cart_quickcart">
    	    ...
    	    <div class="cart_product_content">
    	   		<div class="cart_padding">
					...
					<div class="cart_product_r">
	            		...
	            		<div>
	            		    <a href="#rokquickcart" class="readon"><span><?php echo JText::_('ROKQUICKCART.ADD_TO_CART');?></span></a>
	            		</div>
	            	</div>
            	</div>
            </div>
    ...
    <div class="clr"></div>
    <a id="rokquickcart"></a>
    <h2><?php echo JText::_('ROKQUICKCART.YOUR_CART');?>: (<span class="simpleCart_quantity"></span> <?php echo JText::_('ROKQUICKCART.ITEMS');?>)</h2>
    ...
    <div class="cart_buttons">
        <a href="javascript:;" class="readon"><span><?php echo JText::_('ROKQUICKCART.CHECKOUT');?></span></a>
        <a href="javascript:;" class="readon"><span><?php echo JText::_('ROKQUICKCART.EMPTY_CART');?></span></a>
    </div>
    <div class="clr"></div>
</div>
